...
-(void)setJsonDeleteRequestWithUrl:(NSString *)url headers:(NSDictionary *)headers completion:(void (^)(void))block{
    [self setRequestWithBodyData:nil forHttpMethod:HTTP_METHOD_DELETE url:url headers:headers contentType:CONTENT_TYPE_JSON completion:block];
}
...
-(void)setXmlDeleteRequestWithUrl:(NSString *)url headers:(NSDictionary *)headers completion:(void (^)(void))block{
    [self setRequestWithBodyData:nil forHttpMethod:HTTP_METHOD_DELETE url:url headers:headers contentType:CONTENT_TYPE_XML completion:block];
}
